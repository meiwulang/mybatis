...
public abstract class IntrospectedTable {
	...
	protected void calculateXmlAttributes() {
		...
		setBaseColumnListId("fullColumns"); //$NON-NLS-1$
		setBaseColumnValueListId("fullColumnsValues"); //$NON-NLS-1$
	...
	public void setBaseColumnValueListId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_COLUMN_VALUE_LIST_ID, s);
	}
	...
	public String getBaseColumnValueListId() {
		return internalAttributes.get(InternalAttribute.ATTR_BASE_COLUMN_VALUE_LIST_ID);
	}
	...
	protected String calculateMyBatis3XmlMapperFileName() {
		StringBuilder sb = new StringBuilder();
		sb.append(fullyQualifiedTable.getDomainObjectName());
		sb.append("-sqlmapper.xml"); //$NON-NLS-1$
