...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.BaseColumnValueListElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
	...
	protected XmlElement getSqlMapElement() {
		...
		addBaseColumnValueListElement(answer);
	...
	protected void addBaseColumnValueListElement(XmlElement parentElement) {
		// if (introspectedTable.getRules().generateBaseColumnList()) {
		// AbstractXmlElementGenerator elementGenerator = new
		// BaseColumnListElementGenerator();
		// initializeAndExecuteGenerator(elementGenerator, parentElement);
		// }
		AbstractXmlElementGenerator elementGenerator = new BaseColumnValueListElementGenerator();
		initializeAndExecuteGenerator(elementGenerator, parentElement);
	}
